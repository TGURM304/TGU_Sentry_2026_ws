...
def generate_launch_description():
    ...
    # ros2 run tf2_ros static_transform_publisher --frame-id corrected_base --child-frame-id base_link --qx 1.0 --qy 0.0 --qz 0.0 --qw 0.0
    # odom_map_trans = Node(
    #     package='tf2_ros',
    #     executable='static_transform_publisher',
    #     name='flip_base',
    #     arguments='--frame-id corrected_base --child-frame-id base_link --qx 1.0 --qy 0.0 --qz 0.0 --qw 0.0'.split()
    # )
